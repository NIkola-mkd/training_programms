...
var budgetController = (function () {
   ...
   return {
       ...
       deleteItem: function(type, id) {
            ...
            if (index !== -1) {
                data.allItems[type].splice(index, 1);//removing element by 1
            }
       ...
       calculateBudget: function() {
           ...
           //calculate pct of income that we spent
...
var UIController = (function () {
    ...
    var formatNumber = function(num, type) {
         var numSplit, int, dec, sign, type;
           //+ or - before number 
           //exactly 2 decimal ponts
           ...
           int = numSplit[0];
           if(int.length > 3) {
               int = int.substr(0,int.length-3) + '.' +int.substr(int.length-3,int.length); //inp 210 outp 23.10
           }
           dec = numSplit[1];
